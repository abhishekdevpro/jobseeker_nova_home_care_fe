...
const WhyChooseUsSection = () => {
  const handleBuilder = () => {
    // Add your handleBuilder function implementation here
    console.log("Resume builder clicked");
  };
  ...
  return (
    <div className="flex flex-col items-center bg-white p-8 gap-6">
      <h2 className="text-2xl md:text-3xl font-semibold text-center text-teal-800 leading-snug m-0">
        Why choose us,<br />among other Job sites.
      </h2>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
        {/* Card 1 - Build AI Resume */}
        <div 
          className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-transform duration-300 hover:scale-105 flex flex-col items-center"
        >
          ...
          <Link to="/" className="no-underline">
            <h3 
              className="flex justify-center text-lg font-bold text-teal-700 mb-2 cursor-pointer"
        ...
        >
          ...
          <Link to="/" className="no-underline">
            ...
            <p className="text-teal-500 text-center">
              ...
              Verify your skill and get certified
            </p>
          </Link>
        </div>
      </div>
