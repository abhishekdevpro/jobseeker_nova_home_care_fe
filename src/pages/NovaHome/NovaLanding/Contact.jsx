...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const email = "info@novahome.care"; // Replace with the recipient's email
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="option1">Are you a Caregiver</option>
              <option value="option2">Are you a Caretaker</option>
          ...
          <button
            type="submit"
            className="w-full bg-teal-600 text-white py-3 px-6 rounded-md shadow-lg hover:bg-teal-700 transition duration-300"
          >
            Send Message
          </button>
        </form>
