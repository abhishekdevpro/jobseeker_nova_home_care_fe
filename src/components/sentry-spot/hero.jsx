          ...
          <div className="flex items-center basis-full md:basis-1/2 py-2 md:py-4">
            <div className="sec-title ">
              <h3 className="text-white  text-2xl font-bold">
                Enhance Your Career Prospects with a Novahome Care ID Profile
              </h3>
              <div className="text text-white ">
                With a Novahome Care ID profile, you'll enjoy a customized job
              ...
              >
                <span className="btn-title">Get Your Novahome Care ID now</span>
              </a>
            </div>
          </div>
          {/* End .content-column */}
